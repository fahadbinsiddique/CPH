...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://*.tawk.to https://accounts.google.com https://ssl.gstatic.com https://connect.facebook.net",
      "style-src 'self' 'unsafe-inline' https://accounts.google.com",
      "img-src 'self' https://images.unsplash.com https://res.cloudinary.com https://centreforpsychologicalhealth.com https://*.tawk.to https://lh3.googleusercontent.com https://ssl.gstatic.com data: blob:",
      "font-src 'self'",
