...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "img-src 'self' https://images.unsplash.com https://res.cloudinary.com https://centreforpsychologicalhealth.com https://*.tawk.to https://lh3.googleusercontent.com https://ssl.gstatic.com https://www.facebook.com https://*.google.com data: blob:",
