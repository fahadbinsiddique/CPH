...
const Input = ({ type = 'text', placeholder, className, ...props }) => (
  <input
    ...
    className={`flex h-11 w-full rounded-xl border border-stone-700/50 bg-white/5 px-4 py-2 text-sm text-white placeholder:text-stone-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
    {...props}
  />
)
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16">
              ...
              {trustBadges.map((badge, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-xs text-stone-300 font-medium">{badge.label}</span>
                  </div>
                )
              })}
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs">
            ...
            <Link href="/terms" className="text-stone-500 hover:text-teal-300 transition-colors">
              Terms of Service
            </Link>
            <span className="text-stone-700">|</span>
            <Link href="/cookies" className="text-stone-500 hover:text-teal-300 transition-colors">
              Cookie Policy
            </Link>
            <span className="text-stone-700">|</span>
