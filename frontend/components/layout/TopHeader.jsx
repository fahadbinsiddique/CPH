        ...
        <div className="flex items-center justify-between gap-2 text-xs md:text-sm">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-1 text-xs bg-white/10 px-2 py-1.5 rounded-md text-teal-200 hover:bg-white/20 transition-colors"
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-emerald-600/60 hover:bg-emerald-600/80 px-2.5 py-1.5 rounded-full transition-colors border border-emerald-400/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-900"
            >
