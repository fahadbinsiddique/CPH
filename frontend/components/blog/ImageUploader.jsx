          ...
          <div className="relative h-56 w-full">
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-white/90 px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-sm backdrop-blur-sm transition-colors hover:bg-white"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-rose-500/90 px-3 py-1.5 text-xs font-semibold text-white shadow-sm backdrop-blur-sm transition-colors hover:bg-rose-600"
              >
