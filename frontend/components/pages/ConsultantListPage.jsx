'use client';
// Client implementation of the consultant directory. Rendered by the server wrapper at app/consultant/page.jsx.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 mt-28">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-7">
