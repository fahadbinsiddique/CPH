...
export default function AssessmentProgress({ current, total, title, percentage, topOffset = 0 }) {
  ...
  return (
    <div
      ...
      className="sticky z-20 border-b border-stone-200/70 bg-white/85 backdrop-blur-md"
      style={{ top: topOffset }}
    >
      <div className="mx-auto w-full max-w-2xl px-4 sm:px-6">
        <div className="flex items-center justify-between gap-4 py-3.5">
          <p className="min-w-0 truncate font-heading text-sm font-semibold text-stone-700">
            {title}
          </p>
